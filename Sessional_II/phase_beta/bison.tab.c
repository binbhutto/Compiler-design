...
{
  "$end", "error", "$undefined", "WHILE", "ID", "NUM", "EQUAL",
  "NOT_EQUAL", "LT_EQUAL", "GT_EQUAL", "LT", "GT", "'='", "'+'", "'-'",
  "'*'", "'/'", "'('", "')'", "'{'", "'}'", "';'", "$accept", "D", "$@1",
  "$@2", "C", "$@3", "X", "S", "$@4", "$@5", "$@6", "E", "$@7", "$@8",
  "$@9", "$@10", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     265,   266,    61,    43,    45,    42,    47,    40,    41,   123,
     125,    59
};
# endif
...
{
       1,   -21,    20,   -16,   -21,    25,   -21,    13,    -1,   -21,
     -21,   -21,   -21,   -21,   -21,   -21,    -2,    11,   -21,   -21,
      -2,    10,    28,     3,   -21,   -21,   -21,   -21,   -21,    14,
     -21,    -2,    -2,    -2,    -2,    21,   -21,    12,    12,   -21,
     -21,   -21,    -2,    10,    15,    28,   -21
};
...
{
       0,     2,     0,     0,     1,     0,     5,     0,     0,     3,
       7,     8,     9,    10,    11,    12,     0,     0,    27,    28,
       0,     6,    17,     0,    18,    20,    22,    24,    13,     0,
      26,     0,     0,     0,     0,     0,     4,    19,    21,    23,
      25,    14,     0,    15,     0,    17,    16
};
...
{
      23,     5,    18,    19,     1,    10,    11,    12,    13,    14,
      15,    37,    38,    39,    40,    20,    24,    25,    26,    27,
       4,    30,    43,    24,    25,    26,    27,    26,    27,     6,
      22,     9,    28,    41,    36,    46,    45
};

static const yytype_uint8 yycheck[] =
{
      20,    17,     4,     5,     3,     6,     7,     8,     9,    10,
      11,    31,    32,    33,    34,    17,    13,    14,    15,    16,
       0,    18,    42,    13,    14,    15,    16,    15,    16,     4,
      19,    18,     4,    12,    20,    45,    21
};
...
{
       0,     3,    23,    24,     0,    17,     4,    26,    27,    18,
       6,     7,     8,     9,    10,    11,    28,    25,     4,     5,
      17,    33,    19,    33,    13,    14,    15,    16,     4,    29,
      18,    34,    35,    36,    37,    30,    20,    33,    33,    33,
      33,    12,    31,    33,    32,    21,    29
};

  /* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] =
{
       0,    22,    24,    25,    23,    27,    26,    28,    28,    28,
      28,    28,    28,    30,    31,    32,    29,    29,    34,    33,
      35,    33,    36,    33,    37,    33,    33,    33,    33
};
